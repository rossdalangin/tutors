# EdupreneurPro User Manual

## 1. Getting Started
After activating the plugin, go to **EdupreneurPro → Settings & Tools**.
Click **Load Sample Data** to populate your platform with demonstration courses, users, and orders.

## 2. Building Courses
Go to **EdupreneurPro → Manage Courses**.
1. Click **+ New Course** to create a course shell.
2. Inside the course, click **+ Add Module** to group your content.
3. Inside a module, click **+ Add Lesson**.
4. In the Lesson Modal, select a **Lesson Type** (Video, Quiz, Assignment, etc.).
5. Add **Resources** (PDF/Docs) to any lesson by clicking "+ Add Resource".
6. You can edit any item by clicking the pencil icon (✏️) or delete it with the trash icon (🗑️).
